...
const OcorrenciaDetalhe = () => {
    ...
    if (loading) return <div className="py-30 h-dvh flex flex-col items-center justify-center">
        <Image
            src="/loader-sf.svg"
            alt="Carregando..."
            width={300}
    ...
    if (!ocorrencia) return <p className="text-center text-red-500">Ocorrência não encontrada.</p>;
