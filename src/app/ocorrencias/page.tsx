      ...
      <Container>
        ...
        <div className="grid md:flex gap-10 justify-between">
          <p className="text-lg md:mb-6 text-gray-700 font-(family-name:--font-txt)">
            Aqui você pode visualizar todas as ocorrências registradas na plataforma.
            Fique atento às informações e contribua para manter a comunidade bem informada. <br />
