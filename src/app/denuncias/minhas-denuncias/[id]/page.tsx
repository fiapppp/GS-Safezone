...
const MinhasDenuncias = () => {
  const descricao =
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque nam expedita molestias corrupti voluptatum, adipisci sed sequi labore? Facere voluptates quaerat quidem id explicabo voluptas consectetur dolor dolorum necessitatibus animi!";

  const status = "Aprovada"; // Pode ser: "Aprovada", "Em Análise", "Recusada"
  const pontosGerados = 10;
            ...
            <div className="mt-4 md:flex grid md:justify-between items-center font-(family-name:--font-txt) gap-2">
              ...
              {exibePontos && (
                <p className="text-gray-600">
                  <span className="text-blue-800 font-bold">Pontos Gerados: </span>
                  {pontosGerados}
                </p>
              )}
            </div>
